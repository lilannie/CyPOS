...
document.getElementById("body").onload = REDIPS.drag.init();
var REDIPS = REDIPS || {};
REDIPS.drag = function () {
    var u, F, M, Ea, Qa, Ra, ga, ha, ma, Fa, Ga, Y, na, Ha, T, oa, ba, Ia, G, y, N, pa, qa, ra, Ja, sa, Ka, I, B, La, ia, ja, ta, Sa, Ta, Ma, ua, va, wa, ka, Na, Ua, xa, Va, r = null, J = 0, K = 0, ya = null, za = null, O = [], w = null, P = 0, Q = 0, R = 0, S = 0, U = 0, V = 0, ca, f = [], da, Aa, t, W = [], q = [], C = null, H = null, Z = 0, aa = 0, Wa = 0, Xa = 0, la = !1, Oa = !1, ea = !1, Ba = [], Ca, l = null, x = null, D = null, h = null, z = null, L = null, m = null, E = null, X = null, k = !1, p = !1, v = "cell", Da = {
        div: [],
        cname: "redips-only",
        other: "deny"
    }, Ya = {action: "deny", cname: "redips-mark", exception: []}, n = {}, Za = {
        keyDiv: !1, keyRow: !1,
        sendBack: !1, drop: !1
    };
    M = function () {
    ...
    u = function (a) {
        ...
        for (b = a = 0; a < e.length; a++)if (!("redips_clone" === e[a].parentNode.id || -1 < e[a].className.indexOf("redips-nolayout"))) {
            ...
            c =
                0;
            for (g = !1; c < d.length; c++)if (1 < d[c].rowSpan) {
                g = !0;
                break
            }
        ...
        a = 0;
        for (e = da = 1; a < f.length; a++)if (0 === f[a].redips.nestedLevel) {
    ...
    Ea = function (a) {
        ...
        (C = k.redips.container, u());
        -1 === k.className.indexOf("row") ? REDIPS.drag.mode = v = "cell" : (REDIPS.drag.mode = v = "row", REDIPS.drag.obj = k = ka(k));
        y();
        ...
        if (null === l || null === h || null === m)if (T(), D = x = l, L = z = h, X = E = m, null === l || null === h ||
            null === m)return !0;
        Aa = t = !1;
    ...
    ka = function (a, b) {
        ...
        for (f = e; 0 <= f; f--)if (f !== d.rowIndex) {
            if (!0 === g && void 0 === b)for (e = c.rows[f], A = 0; A < e.cells.length; A++)if (-1 < e.cells[A].className.indexOf("redips-rowhandler")) {
                g = !1;
                break
            }
            c.deleteRow(f)
    ...
    ga = function (a) {
        ...
        U = V = 0;
        if (!t || "cell" !== v || null !== l && null !== h && null !== m)if (null === l || null === h || null === m)REDIPS.drag.event.notMoved(); else {
            l < f.length ?
            ...
            if ("row" === v)if (Aa)if (D === c && L === d) {
                ...
                }, 20) : Fa(); else if ("switch" === REDIPS.drag.dropMode)if (a = REDIPS.drag.event.droppedBefore(n.target), !1 === a)ma(!1); else {
                k.parentNode.removeChild(k);
            ...
            REDIPS.drag.dropMode ? (a = REDIPS.drag.event.droppedBefore(n.target), !1 !== a && ja(n.target)) : a = REDIPS.drag.event.droppedBefore(n.target), ma(a); else REDIPS.drag.event.notMoved();
    ...
    ma = function (a) {
        ...
        if (!1 !== a) {
            if (!0 === Za.sendBack) {
                ...
                for (c = 0; c < a.length; c++)if (k !== a[c] && 0 === k.id.indexOf(a[c].id)) {
                    b =
                        a[c];
                    break
                }
    ...
    ha = function (a) {
        a =
            a || window.event;
        var b = REDIPS.drag.scroll.bound, c, d, e, g;
        a.touches ? (d = Z = a.touches[0].clientX, e = aa = a.touches[0].clientY) : (d = Z = a.clientX, e = aa = a.clientY);
        c = Math.abs(Wa - d);
        g = Math.abs(Xa - e);
        if (!Aa) {
            if ("cell" === v && (ea || !0 === REDIPS.drag.clone.keyDiv && Oa))REDIPS.drag.objOld = p = k, REDIPS.drag.obj = k = ra(k, !0), t = !0, REDIPS.drag.event.cloned(); else {
                if ("row" === v) {
    ...
    T = function () {
        ...
        b = Z;
        g = aa;
        for (l = 0; l < f.length; l++)if (!1 !== f[l].redips.enabled && (c[0] = f[l].redips.offset[0], c[1] = f[l].redips.offset[1], c[2] = f[l].redips.offset[2], c[3] = f[l].redips.offset[3], void 0 !== f[l].sca && (c[0] = c[0] > f[l].sca.offset[0] ? c[0] : f[l].sca.offset[0], c[1] = c[1] < f[l].sca.offset[1] ?
            ...
            for (h = 0; h < c.length - 1; h++)if (void 0 !== c[h]) {
                q[0] = c[h][0];
                if (void 0 !== c[h + 1])q[2] = c[h + 1][0]; else for (d = h + 2; d < c.length; d++)if (void 0 !== c[d]) {
                    q[2] = c[d][0];
                    break
                }
                if (g <= q[2])break
            ...
            do for (m = e = f[l].rows[h].cells.length - 1; 0 <= m && !(q[3] = c[h][3] + f[l].rows[h].cells[m].offsetLeft,
            ...
            if (-1 === b.className.indexOf(REDIPS.drag.trash.className))if (g = -1 < b.className.indexOf(REDIPS.drag.only.cname), !0 === g) {
    ...
    Ia = function (a, b, c) {
        ...
        if ("cell" === v)c = f[a].rows[b].cells[c], d.color[0] = c.style.backgroundColor, void 0 !== REDIPS.drag.hover.borderTd && (d.top[0] = e(c, "Top"), d.right[0] = e(c, "Right"), d.bottom[0] = e(c, "Bottom"), d.left[0] = e(c, "Left")); else for (a = f[a].rows[b], b = 0; b < a.cells.length; b++)c = a.cells[b], d.color[b] = c.style.backgroundColor, void 0 !== REDIPS.drag.hover.borderTr &&
    ...
    ra = function (a, b) {
        var c = a.cloneNode(!0), d = c.className, e, g;
    ...
    F = function (a, b) {
        var c, d, e, g = [], f = [], A, k, h, l, n = /\bredips-drag\b/i, m = /\bredips-noautoscroll\b/i;
        ...
        for (d = c = 0; c < g.length; c++)if (n.test(g[c].className))"init" ===
        a || void 0 === g[c].redips ? (g[c].redips = {}, g[c].redips.container = C) : !0 === a && "number" === typeof k ? (g[c].style.opacity = "", g[c].style.filter = "") : !1 === a && "number" === typeof k && (g[c].style.opacity = k / 100, g[c].style.filter = "alpha(opacity=" + k + ")"), Y(g[c], l), g[c].style.borderStyle = A, g[c].style.cursor = h, g[c].redips.enabled = l; else if ("init" === a && (e = I(g[c], "overflow"), "visible" !== e)) {
            ...
            O[d] = {
                ...
                f[3]) / 2, midstY: (f[0] + f[2]) / 2, autoscroll: e
            };
    ...
    ia = function (a, b, c) {
        ...
        d = function (a, b) {
            ...
            REDIPS.drag.moveObject({
                obj: a, target: c, callback: function (a) {
        ...
        if (a !== b && "object" === typeof a && "object" === typeof b)if (g = a.childNodes.length, "animation" === c) {
            if (0 < g)for (c = B("TABLE", b), e = c.redips.idx, REDIPS.drag.enableTable(!1, c), c = 0; c < g; c++)1 === a.childNodes[c].nodeType && "DIV" === a.childNodes[c].nodeName && (Ba[e]++, d(a.childNodes[c], b))
        } else for (d = c = 0; c < g; c++)1 === a.childNodes[d].nodeType && "DIV" === a.childNodes[d].nodeName ? (e = a.childNodes[d], REDIPS.drag.event.relocateBefore(e,
    ...
    ta = function (a, b) {
        var c, d, e, g, f, k, h, l, m, q, p, r, t = !1, u, v;
        u = function (a, b) {
    ...
    Sa = function (a) {
        var b = [], c, d = {}, e, g, f, k, h, l, m, n;
        k = a.rows;
        for (h = 0; h < k.length; h++)for (l = 0; l < k[h].cells.length; l++) {
            c = k[h].cells[l];
            ...
            b[a] = b[a] || [];
            for (m =
                     0; m < b[a].length + 1; m++)if ("undefined" === typeof b[a][m]) {
                f = m;
                break
            }
            d[a + "-" + f] = c;
            ...
            for (m = a; m < a + e; m++)for (b[m] = b[m] || [], c = b[m], n = f; n < f + g; n++)c[n] = "x"
        }
        return d
    };
    Ta = function (a) {
    ...
    Ma = function (a, b) {
        ...
        a < b.last && 0 < b.direction || a > b.last && 0 > b.direction ? setTimeout(function () {
            Ma(a, b)
        }, REDIPS.drag.animation.pause * c) : (Ga(b.obj), b.obj.redips && (b.obj.redips.animated = !1), "cell" === b.mode ? (!0 === b.overwrite && ja(b.targetCell), b.targetCell.appendChild(b.obj), b.obj.redips && !1 !== b.obj.redips.enabled && Y(b.obj)) : Na(ua(b.target[0]), b.target[1], b.obj), "function" === typeof b.callback && b.callback(b.obj))
    };
    va = function (a) {
        var b, c, d;
        b = [];
        b = c = d = -1;
        if (void 0 === a)b = l < f.length ? f[l].redips.idx : null === x || null === z || null === E ? f[D].redips.idx : f[x].redips.idx, c = f[D].redips.idx, b = [b, h, m, c, L, X]; else {
    ...
    wa = function (a, b, c) {
        ...
        if ("TR" === a.nodeName)for (a = a.getElementsByTagName("td"), d = 0; d < a.length; d++)if (a[d].style.backgroundColor = c ? c : "", "empty" === b)a[d].innerHTML = ""; else for (e = 0; e < a[d].childNodes.length; e++)1 === a[d].childNodes[e].nodeType && (a[d].childNodes[e].style.opacity =
            b / 100, a[d].childNodes[e].style.filter = "alpha(opacity=" + b + ")"); else a.style.opacity = b / 100, a.style.filter = "alpha(opacity=" + b + ")", a.style.backgroundColor = c ? c : ""
    };
    return {
        obj: k,
        objOld: p,
        ...
        only: Da,
        mark: Ya,
        style: {borderEnabled: "solid", borderDisabled: "dotted", opacityDisabled: "", rowEmptyColor: "white"},
        ...
        saveContent: function (a, b) {
            var c = "", d, e, f, h, k, l, m, n = [], p = REDIPS.drag.saveParamName;
            "string" === typeof a && (a = document.getElementById(a));
            if (void 0 !== a && "object" === typeof a && "TABLE" === a.nodeName) {
                d = a.rows.length;
                for (k = 0; k < d; k++)for (e = a.rows[k].cells.length, l = 0; l < e; l++)if (f = a.rows[k].cells[l], 0 < f.childNodes.length)for (m = 0; m < f.childNodes.length; m++)h = f.childNodes[m], "DIV" === h.nodeName && -1 < h.className.indexOf("redips-drag") && (c += p + "[]=" + h.id + "_" + k + "_" + l + "&", n.push([h.id, k, l]));
